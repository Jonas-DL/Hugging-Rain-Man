...
- **Mega Cloud (Only Pre-trained Models, The regression model needs to be downloaded in Baidu Cloud)**: [Download Link](https://mega.nz/folder/GVYRmbKa#5vfygvAm0mYl_h-6YbFzAQ
)
...
change the output dimension to 17. Alternatively, you can use the code snippets we provide in the [Predict](https://github.com/Jonas-DL/Hugging-Rain-Man/tree/main/Predict) directory to 
